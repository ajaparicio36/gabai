...
from .features import FeaturePayload, FEATURE_ORDER
from .formulas import formula_infer, FormulaResult
...
def retrain(request: RetrainRequest = RetrainRequest()) -> dict[str, Any]:
    import json

    import requests

    nest_url = os.environ.get(
        "NESTJS_INTERNAL_URL", "http://localhost:3000/api/v1"
    )
