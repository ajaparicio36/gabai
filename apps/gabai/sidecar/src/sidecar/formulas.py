...
def formula_infer(
    ...
    if property_type == "residential_lot":
        return value_residential_lot(lot_area_sqm, zonal_value_php, proximity_score=proximity_score)
    elif property_type == "house_and_lot":
        return value_house_and_lot(lot_area_sqm, floor_area_sqm, zonal_value_php, crep_php, building_age_years, proximity_score)
        ...
        return formula_infer(lot_area_sqm, floor_area_sqm, "residential_lot", zonal_value_php, crep_php, building_age_years, proximity_score)
